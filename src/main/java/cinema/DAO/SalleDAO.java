...
public class SalleDAO extends DAO<Salle> {
    ...
    public boolean create(Salle obj) {
        ...
        try {
            ...
            if (ps.executeUpdate() > 0) {
                result = true; // executeUpdate retourne le nombre de lignes insérées
            ...
            e.printStackTrace(); // affiche l'erreur SQL en console
        }
    ...
    public boolean delete(Salle obj) {
        ...
        try (PreparedStatement ps = this.connect.prepareStatement(query)) { // try-with-resources ferme automatiquement le statement
            ...
            // 🔥 récupérer l'ancien avant suppression
    ...
    public boolean update(Salle obj) {
        ...
        try {
            // 🔥 récupérer l'ancien avant modification
            Salle ancienneSalle = find(obj.getIdSalle());
    ...
    public List<Salle> findByCinema(int idCinema) {
        ...
        String query = "SELECT * FROM salle WHERE id_cinema = ?;"; // filtre
